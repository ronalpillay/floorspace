      ...
      <div className="c-footer-top">
        ...
        <div className="c-footer-brand">
          ...
          <div className="c-footer-social">
            <a href="https://www.instagram.com/floorspaceindia" target="_blank" rel="noopener noreferrer" className="c-footer-social-btn" aria-label="Instagram">
            ...
            <a href="https://www.linkedin.com/company/floor-space-india" target="_blank" rel="noopener noreferrer" className="c-footer-social-btn" aria-label="LinkedIn">
        ...
        <div className="c-footer-contact">
          ...
          <p className="c-footer-contact-row">Viman Nagar, Pune – 411014</p>
